...
export default grammar({
  ...
  rules: {
    ...
    _inner_text: $ => repeat1(choice($.keyword, field('identifier', $.dotted_identifier), field('identifier', $.identifier), $._white_space, $.filter_operator, $.equal_operator, $.operator, $.string, $.map)),
    _inner_text2: $ => repeat1(choice(field('identifier', $.dotted_identifier), field('identifier', $.identifier), $._white_space, $.filter_operator, $.equal_operator, $.operator, $.string, $.map)),
