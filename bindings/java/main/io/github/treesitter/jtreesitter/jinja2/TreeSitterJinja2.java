package io.github.treesitter.jtreesitter.jinja2;

import java.lang.foreign.*;

public final class TreeSitterJinja2 {
    ...
    private static final TreeSitterJinja2 INSTANCE = new TreeSitterJinja2();

    private final Arena arena = Arena.ofAuto();
    private volatile SymbolLookup lookup = null;

    private TreeSitterJinja2() {}
    ...
    public static MemorySegment language(SymbolLookup lookup) {
        return call(lookup, "tree_sitter_jinja2");
    }

    private SymbolLookup findLibrary() {
        try {
            var library = System.mapLibraryName("tree-sitter-jinja2");
            return SymbolLookup.libraryLookup(library, arena);
        } catch (IllegalArgumentException ex1) {
            try {
                System.loadLibrary("tree-sitter-jinja2");
